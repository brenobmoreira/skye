...
var Events = []string{"SessionStart", "UserPromptSubmit", "PostToolUse", "Notification", "PermissionRequest", "Stop", "SessionEnd", "PreCompact", "PostCompact", "SubagentStart", "SubagentStop"}
